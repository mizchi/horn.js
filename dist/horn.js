(function() {
  var Dispatchable, Querified, Removable, extend,
    __slice = [].slice;
  ...
  Horn.ListView = (function() {
    extend(ListView.prototype, Querified);

    extend(ListView.prototype, Dispatchable);

    extend(ListView.prototype, Removable);
